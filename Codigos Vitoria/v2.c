...
int main( int argc, char* args[] )
{
    ...
    pegaAsImagens();
    musica=Mix_LoadMUS("harry1.mp3");
    fase=Mix_LoadMUS("harry2.mp3");
...
void pegaAsImagens()
{
    Background = IMG_Load("fundo4.png");
    Background2 = IMG_Load("fundo2.png");
    Background3 = IMG_Load("fundo3.png");
    Background4 = IMG_Load("fundo5.png");
    Player = IMG_Load("Harry.png");
    In1 = IMG_Load("Malfoy.png");
    In2 = IMG_Load("Bellatix.png");
    In3 = IMG_Load("Demetador.png");
    in4 = IMG_Load("Dolores.png");
    Boss = IMG_Load("chefe2.png");
    bullet = IMG_Load("missile.png");
    menu=IMG_Load("menu.png");
    logo=IMG_Load("logo1.png");
    instrucoes=IMG_Load("Instrucoes.png");
...
void fase4()
{
    ...
    { 
        ...
        //Atualiza a tela de fundo
        SDL_BlitSurface(Background4, NULL, Screen, NULL);
        sprintf(pontuacao, "                                                                 Pontos: %d", pont);
        escrever = TTF_RenderText_Solid(fonte, pontuacao, cor);
        SDL_BlitSurface(escrever, NULL, Screen, &dst_rect);
        if(Pause==0)
